...
"""
This module implements the :py:class:`~neoradium.tdl.TdlChannel` class which
encapsulates the Tapped Delay Line (TDL) channel model functionality.
"""
# ****************************************************************************************************************************************************
# Revision History:
...
# 11/31/2023    Shahab Hamidi-Rad       Completed the documentation
# ****************************************************************************************************************************************************
import numpy as np
...
# ****************************************************************************************************************************************************
# Pre-calculated correlation matrixes:
        ...
        'Downlink': { # For Downlink Antenna Config is:  ng x nu (nt x nr)
            'CoPolar':  {
                'High':     {   # Downlink - CoPolar - High => TS 38.101-4 V17.4.0 (2022-03), Table B.2.3.1.2-2
                            ...
                            '4x4':[[ 1.0000, 0.9882, 0.9541, 0.8999, 0.9882, 0.9767, 0.9430, 0.8894, 0.9541, 0.9430, 0.9105, 0.8587, 0.8999, 0.8894, 0.8587, 0.8099 ],
                ...
                'MediumA':  {   # Downlink - CoPolar - MediumA => TS 38.101-4 V17.4.0 (2022-03), Table B.2.3.1.2-4
                            ...
                            '4x4':[[ 1.0000, 0.9000, 0.6561, 0.3874, 0.8748, 0.7873, 0.5739, 0.3389, 0.5856, 0.5270, 0.3842, 0.2269, 0.3000, 0.2700, 0.1968, 0.1162 ],
                                   ...
                                   [ 0.5856, 0.5270, 0.3842, 0.2269, 0.8748, 0.7873, 0.5739, 0.3389, 1.0000, 0.9000, 0.6561, 0.3874, 0.8748, 0.7873, 0.5739, 0.3389 ],
                ...
                'Low':      {   # Downlink - CoPolar - Low => TS 38.101-4 V17.4.0 (2022-03), Table B.2.3.1.2-5
                                # Note that returning a scaler value means an identity matrix of the specified size
                            '1x2': 2,
                            '1x4': 4,
                            '2x1': 2,
                            '2x2': 4,
            ...
            'CrossPolar':{
                'High':     {   # Downlink - CrossPolar - High => TS 38.101-4 V17.4.0 (2022-03), Table B.2.3.2.2-2
                            ...
                            '4x4':[[ 1.   ,  0.9  ,  0.   ,  0.   ,  0.9  ,  0.81 ,  0.   ,  0.   , -0.3  , -0.27 ,  0.   ,  0.   , -0.27 , -0.243,  0.   ,  0.   ],
                                   [ 0.9  ,  1.   ,  0.   ,  0.   ,  0.81 ,  0.9  ,  0.   ,  0.   , -0.27 , -0.3  ,  0.   ,  0.   , -0.243, -0.27 ,  0.   ,  0.   ],
                                   [ 0.   ,  0.   ,  1.   ,  0.9  ,  0.   ,  0.   ,  0.9  ,  0.81 , 0.    ,  0.   ,  0.3  ,  0.27 ,  0.   ,  0.   ,  0.27 ,  0.243],
                                   [ 0.   ,  0.   ,  0.9  ,  1.   ,  0.   ,  0.   ,  0.81 ,  0.9  , 0.    ,  0.   ,  0.27 ,  0.3  ,  0.   ,  0.   ,  0.243,  0.27 ],
                                   [ 0.9  ,  0.81 ,  0.   ,  0.   ,  1.   ,  0.9  ,  0.   ,  0.   , -0.27 , -0.243,  0.   ,  0.   , -0.3  , -0.27 ,  0.   ,  0.   ],
                                   [ 0.81 ,  0.9  ,  0.   ,  0.   ,  0.9  ,  1.   ,  0.   ,  0.   , -0.243, -0.27 ,  0.   ,  0.   , -0.27 , -0.3  ,  0.   ,  0.   ],
                                   [ 0.   ,  0.   ,  0.9  ,  0.81 ,  0.   ,  0.   ,  1.   ,  0.9  , 0.    ,  0.   ,  0.27 ,  0.243,  0.   ,  0.   ,  0.3  ,  0.27 ],
                                   [ 0.   ,  0.   ,  0.81 ,  0.9  ,  0.   ,  0.   ,  0.9  ,  1.   , 0.    ,  0.   ,  0.243,  0.27 ,  0.   ,  0.   ,  0.27 ,  0.3  ],
                                   [-0.3  , -0.27 ,  0.   ,  0.   , -0.27 , -0.243,  0.   ,  0.   , 1.    ,  0.9  ,  0.   ,  0.   ,  0.9  ,  0.81 ,  0.   ,  0.   ],
                                   [-0.27 , -0.3  ,  0.   ,  0.   , -0.243, -0.27 ,  0.   ,  0.   , 0.9   ,  1.   ,  0.   ,  0.   ,  0.81 ,  0.9  ,  0.   ,  0.   ],
                                   [ 0.   ,  0.   ,  0.3  ,  0.27 ,  0.   ,  0.   ,  0.27 ,  0.243, 0.    ,  0.   ,  1.   ,  0.9  ,  0.   ,  0.   ,  0.9  ,  0.81 ],
                                   [ 0.   ,  0.   ,  0.27 ,  0.3  ,  0.   ,  0.   ,  0.243,  0.27 , 0.    ,  0.   ,  0.9  ,  1.   ,  0.   ,  0.   ,  0.81 ,  0.9  ],
                                   [-0.27 , -0.243,  0.   ,  0.   , -0.3  , -0.27 ,  0.   ,  0.   , 0.9   ,  0.81 ,  0.   ,  0.   ,  1.   ,  0.9  ,  0.   ,  0.   ],
                                   [-0.243, -0.27 ,  0.   ,  0.   , -0.27 , -0.3  ,  0.   ,  0.   , 0.81  ,  0.9  ,  0.   ,  0.   ,  0.9  ,  1.   ,  0.   ,  0.   ],
                                   [ 0.   ,  0.   ,  0.27 ,  0.243,  0.   ,  0.   ,  0.3  ,  0.27 , 0.    ,  0.   ,  0.9  ,  0.81 ,  0.   ,  0.   ,  1.   ,  0.9  ],
                                   [ 0.   ,  0.   ,  0.243,  0.27 ,  0.   ,  0.   ,  0.27 ,  0.3  , 0.    ,  0.   ,  0.81 ,  0.9  ,  0.   ,  0.   ,  0.9  ,  1.   ]],
                            '8x2':[[  1.0000, 0.0000,  0.9883, 0.0000,  0.9542, 0.0000,  0.8999, 0.0000, -0.3000, 0.0000, -0.2965, 0.0000, -0.2862, 0.0000, -0.2700, 0.0000 ],
                                   ...
                                   [ -0.3000, 0.0000, -0.2965, 0.0000, -0.2862, 0.0000, -0.2700, 0.0000,  1.0000, 0.0000,  0.9883, 0.0000,  0.9542, 0.0000,  0.8999, 0.0000 ],
                ...
                'Medium':   {   # Downlink - CrossPolar - MediumA => TS 38.101-4 V17.4.0 (2022-03), Table B.2.3.2.2-3
                            '2x2':[[ 1.0,  0.0, -0.2, 0.0 ],
                                   ...
                                   [ -0.2, 0.0,  1.0, 0.0 ],
                                   [ 0.0,  0.2,  0.0, 1.0 ]],
                            '4x4':[[  1.0000,  0.6000, 0.0000, 0.0000,  0.3000,  0.1800, 0.0000, 0.0000, -0.2000, -0.1200, 0.0000, 0.0000, -0.0600, -0.0360, 0.0000, 0.0000 ],
                                   [  0.6000,  1.0000, 0.0000, 0.0000,  0.1800,  0.3000, 0.0000, 0.0000, -0.1200, -0.2000, 0.0000, 0.0000, -0.0360, -0.0600, 0.0000, 0.0000 ],
                                   [  0.0000,  0.0000, 1.0000, 0.6000,  0.0000,  0.0000, 0.3000, 0.1800,  0.0000,  0.0000, 0.2000, 0.1200,  0.0000,  0.0000, 0.0600, 0.0360 ],
                                   [  0.0000,  0.0000, 0.6000, 1.0000,  0.0000,  0.0000, 0.1800, 0.3000,  0.0000,  0.0000, 0.1200, 0.2000,  0.0000,  0.0000, 0.0360, 0.0600 ],
                                   [  0.3000,  0.1800, 0.0000, 0.0000,  1.0000,  0.6000, 0.0000, 0.0000, -0.0600, -0.0360, 0.0000, 0.0000, -0.2000, -0.1200, 0.0000, 0.0000 ],
                                   [  0.1800,  0.3000, 0.0000, 0.0000,  0.6000,  1.0000, 0.0000, 0.0000, -0.0360, -0.0600, 0.0000, 0.0000, -0.1200, -0.2000, 0.0000, 0.0000 ],
                                   [  0.0000,  0.0000, 0.3000, 0.1800,  0.0000,  0.0000, 1.0000, 0.6000,  0.0000,  0.0000, 0.0600, 0.0360,  0.0000,  0.0000, 0.2000, 0.1200 ],
                                   [  0.0000,  0.0000, 0.1800, 0.3000,  0.0000,  0.0000, 0.6000, 1.0000,  0.0000,  0.0000, 0.0360, 0.0600,  0.0000,  0.0000, 0.1200, 0.2000 ],
                                   [ -0.2000, -0.1200, 0.0000, 0.0000, -0.0600, -0.0360, 0.0000, 0.0000,  1.0000,  0.6000, 0.0000, 0.0000,  0.3000,  0.1800, 0.0000, 0.0000 ],
                                   [ -0.1200, -0.2000, 0.0000, 0.0000, -0.0360, -0.0600, 0.0000, 0.0000,  0.6000,  1.0000, 0.0000, 0.0000,  0.1800,  0.3000, 0.0000, 0.0000 ],
                                   [  0.0000,  0.0000, 0.2000, 0.1200,  0.0000,  0.0000, 0.0600, 0.0360,  0.0000,  0.0000, 1.0000, 0.6000,  0.0000,  0.0000, 0.3000, 0.1800 ],
                                   [  0.0000,  0.0000, 0.1200, 0.2000,  0.0000,  0.0000, 0.0360, 0.0600,  0.0000,  0.0000, 0.6000, 1.0000,  0.0000,  0.0000, 0.1800, 0.3000 ],
                                   [ -0.0600, -0.0360, 0.0000, 0.0000, -0.2000, -0.1200, 0.0000, 0.0000,  0.3000,  0.1800, 0.0000, 0.0000,  1.0000,  0.6000, 0.0000, 0.0000 ],
                                   [ -0.0360, -0.0600, 0.0000, 0.0000, -0.1200, -0.2000, 0.0000, 0.0000,  0.1800,  0.3000, 0.0000, 0.0000,  0.6000,  1.0000, 0.0000, 0.0000 ],
                                   [  0.0000,  0.0000, 0.0600, 0.0360,  0.0000,  0.0000, 0.2000, 0.1200,  0.0000,  0.0000, 0.3000, 0.1800,  0.0000,  0.0000, 1.0000, 0.6000 ],
                                   [  0.0000,  0.0000, 0.0360, 0.0600,  0.0000,  0.0000, 0.1200, 0.2000,  0.0000,  0.0000, 0.1800, 0.3000,  0.0000,  0.0000, 0.6000, 1.0000 ]]
                            }
                        }
                    },
...
# ****************************************************************************************************************************************************
class TdlChannel(ChannelBase):
    r"""
    This class implements the Tapped Delay Line (TDL) channel model based
    on **3GPP TR 38.901**. It is derived from the
    :py:class:`~neoradium.channel.ChannelBase` class.
    
    According to **3GPP TR 38.901**, TDL models are mostly used for simplified
    evaluations, for non-MIMO cases. They are defined for the frequency range
    from 0.5 GHz to 100 GHz with a maximum bandwidth of 2 GHz.
    
    Although TDL model is defined for mostly non-MIMO use cases, this
    implementation does support MIMO configs. However, unlike
    :py:class:`~neoradium.cdl.CdlChannel`, this model does not work
    with the antenna classes :py:class:`~neoradium.antenna.AntennaPanel`
    or :py:class:`~neoradium.antenna.AntennaArray`. For TDL channel models,
    you just need to specify the number of transmit and receive antenna.
    
    The typical use case involves instantiating a :py:class:`TdlChannel` object
    ...
    def __init__(self, profile='A', **kwargs):
        ...
        profile : str or None (default: 'A')
            The TDL profile name. It can be one of the following:
                ...
                * A string that specifies both profile and delay spread
                  according to **3GPP TS 38.101-4**: 'A30', 'B100', 'C60',
                  'C300', 'D30'. The numbers here are the delay spread in
                  nano seconds. Please note that the delay spread specified
                  here overrides any value passed to the ``delaySpread``
                  parameter (See :py:class:`~neoradium.channel.ChannelBase`)

                * A string that specifies profile, delay spread, and
                  doppler shift according to **3GPP TS 38.101-4 Table
                  B.2.2-1** and **3GPP TS 38.101-4 Table B.2.2-2**. This
                  includes 'A30-5', 'A30-10', 'B100-400', 'C300-100',
                  'C300-600', 'C300-1200', for FR1, and 'A30-35', 'A30-75',
                  'A30-300', 'C60-300', 'D30-75' for FR2. Please note that
                  the delay spread and doppler shift specified here overrides
                  any values passed to the ``delaySpread`` and ``dopplerShift``
                  parameters (See :py:class:`~neoradium.channel.ChannelBase`)
                  
                * ``None`` can be used to completely customize the TDL
                  channel. See :ref:`Customizing TDL Model <CustomizingTDL>`
        ...
        kwargs : dict
            ...
            ``TdlChannel``.
                ...
                :txAntennaCount: The number of transmitter antenna. Isotropic
                    antenna elements are assumed. The default is 1.
                
                :rxAntennaCount: The number of receiver antenna. Isotropic
                    antenna elements are assumed. The default is 1.

                :mimoCorrelation: Specifies the relative amount of MIMO correlation
                    in MIMO use cases. It can be one of 'Low' (default), 'Medium',
                    'MediumA', 'MediumB', and 'High'. See
                    :ref:`Calculating Correlation Matrix <CalculatingCorrMat>`
                    for more information.
                    
                :polarization: The polarization type for the MIMO use cases. It can
                    be one of 'CoPolar'(default) or 'CrossPolar'. See
                    :ref:`Calculating Correlation Matrix <CalculatingCorrMat>`
                    for more information.
                    
                :correlationMatrix: The correlation matrix. By default this
                    implementation calculates the correlation matrix based on 3GPP
                    standard using the given parameters such as ``mimoCorrelation``
                    and ``polarization``. However you can specify your own
                    correlation matrix using this parameter. See
                    :ref:`Calculating Correlation Matrix <CalculatingCorrMat>`
                    for more information.
                
                :sosType: The TDL model uses the Sum-of-Sinusoids method to calculate
                    the channel gains. This implementation supports 2 different
                    variations of this technique:
                    
                    * **`GMEDS1`**: The method introduced in the paper `"Two New
                      Sum-of-Sinusoids-Based Methods for the Efficient Generation of
                      Multiple Uncorrelated Rayleigh Fading Waveforms"
                      <https://ieeexplore.ieee.org/document/5089993>`_. This is the
                      default method.
                    
                    * **`Xiao`**: The method introduced in the paper `"Novel
                      Sum-of-Sinusoids Simulation Models for Rayleigh and Rician
                      Fading Channels" <https://ieeexplore.ieee.org/document/4027602>`_.
                      Please note that this is a stateless statistical model. Sequential
                      application of this channel model may not always have smooth
                      transition between the resulting channel gains.
                        
                :sosNumSins: The number of Sinusoids used in the Sum-of-Sinusoids
                    algorithm. The default is 32.
                
                :pathDelays: Use this to customize or override the path delays which
                    by default are set based on the TDL channel model as defined in
                    **3GPP TR 38.901 Tables Tables 7.7.2-1 to Table 7.7.2-5**. You
                    don't need to specify this parameter for most use cases. See
                    :ref:`Customizing TDL Model <CustomizingTDL>` below for more
                    information.
                ...
                :kFactorLos: The K-Factor ratio (in dB) for the LOS tap (1st tap).
                    this value by default is set to ``(pathPowers[0]-pathPowers[1])``.

                :hasLos: Use this to customize or override the ``hasLos`` property of
                    this channel model which by default is set based on the TDL channel
        ...
        **Other Properties:**
        ...
        properties. Here is a list of additional properties specific to this class.
            ...
            :nrNt: A tuple of the form ``(nr,nt)``, where ``nr`` and ``nt`` are the
                ...
                For TDL models, ``nr`` and ``nt`` are the same as ``rxAntennaCount``
                and nt=txAntennaCount`` parameters.
        ...
        **Calculating Correlation Matrix:**
        ...
        For MIMO use cases, by default, this class uses the parameters such as
        ``mimoCorrelation`` and ``polarization`` to calculate the correlation
        matrix based on the 3GPP standard documents. This implementation is based
        ...
        **Customizing TDL Model:**
        ...
        a) You can choose one of the predefined TDL profiles (See the ``profile``
           parameter above) and then modify the parameters of the model by passing
           in additional information. For example you can choose 'B100-400' for
           ``profile`` and then pass your own path delays to override the path
           delays specified in the standard.
           
        b) You can also define your own model completely from scratch. You first pass
           ...
           Also note that if your channel model contains a LOS tap, it **must** be
           the first tap in the lists and the ``hasLos`` parameter should be set
           to ``True``.
        ...
        if profile in ['A30-5', 'A30-10', 'B100-400', 'C300-100', 'C300-600', 'C300-1200', # TS 38.101-4 V17.4.0 (2022-03) - Table B.2.2-1  (FR1)
                       'A30-35', 'A30-75', 'A30-300', 'C60-300', 'D30-75']:                # TS 38.101-4 V17.4.0 (2022-03) - Table B.2.2-2  (FR2)
        ...
        # We assume Isotropic Antenna always
        ...
        self.pathDelays = kwargs.get('pathDelays', getTdlValue(0))  # Normalized Path Delays. The actual delays are set in the "scaleDelays"
        ...
        self.kFactorLos = kwargs.get('kFactorLos', (self.pathPowers[0]-self.pathPowers[1]) if self.hasLos else None) # This is in DB (e.g.: TDL-D:13.3, TDL-E:22)
        ...
        if len(self.pathDelays)!=len(self.pathPowers):  raise ValueError("Tap delays and powers must have the same size!")
        ...
        if self.hasLos:
            ...
            self.pathPowers = np.concatenate( ([10*np.log10( (10**(self.pathPowers[:2]/10.0)).sum())], self.pathPowers[2:]) )
        ...
        if self.polarization not in ['CoPolar', 'CrossPolar']:
            raise ValueError("Unsupported 'polarization' (%s). It must be one of 'CoPolar' or 'CrossPolar'."%(self.polarization))
        ...
        if self.sosType not in ['GMEDS1', 'Xiao']:
            raise ValueError("Unsupported 'sosType' (%s). It must be one of 'GMEDS1' or 'Xiao'."%(self.sosType))
        self.sosNumSins = kwargs.get('sosNumSins', 32 )

        # Initial phases for the GMEDS1 SOS method
        nr, nt = self.nrNt
        self.sosTheta1N = self.rangen.random(size=(1, self.sosNumSins, nr, nt, self.numPaths))*2*np.pi     # Uniform between 0,2𝛑, Shape: 1 x sosNumSins x nr x nt x numPaths
        self.sosTheta2N = self.rangen.random(size=(1, self.sosNumSins, nr, nt, self.numPaths))*2*np.pi     # Uniform between 0,2𝛑, Shape: 1 x sosNumSins x nr x nt x numPaths

        self.channelFilter = self.makeFilter()
        self.restart()
    ...
    def print(self, indent=0, title=None, getStr=False):
        ...
        then adds the information specific to :py:class:`~neoradium.tdl.TdlChannel`
        class.
        ...
        """
        if title is None:   title = "TDL-%s Channel Properties:"%(self.profile)
        repStr = super().print(indent, title, True)
        
        numPerLine = min(12, len(self.pathDelays))
        ...
        if self.hasLos:
            repStr += indent*' ' + "  kFactorLos (db): %6f\n"%(self.kFactorLos)

        repStr += indent*' ' + "  rxAntennaCount: %d\n"%(self.rxAntennaCount)
        repStr += indent*' ' + "  txAntennaCount: %d\n"%(self.txAntennaCount)

        repStr += indent*' ' + "  mimoCorrelation: %s\n"%(self.mimoCorrelation)
        repStr += indent*' ' + "  polarization: %s\n"%(self.polarization)

        repStr += indent*' ' + "  sosType: %s\n"%(self.sosType)
        repStr += indent*' ' + "  sosNumSins: %s\n"%(self.sosNumSins)
    ...
    def sosXiao(self, sosSampleTimes):              # Not documented
        ...
        # Note: This is a statistical model. Sequential calls to 'getChannelGains' function may not always have smooth transition between the resulting gains.
        nr, nt = self.nrNt
        ...
        thetaN = self.rangen.random(size=(1, self.sosNumSins, 1, 1, self.numPaths))*2*np.pi - np.pi     # Uniform between -𝛑,𝛑, Shape: 1 x sosNumSins x 1 x 1 x numPaths
        phiN   = self.rangen.random(size=(1, self.sosNumSins, nr, nt, self.numPaths))*2*np.pi - np.pi   # Uniform between -𝛑,𝛑, Shape: 1 x sosNumSins x nr x nt x numPaths

        # See Equation (7) in the above paper:
        alphaN = (2 * np.pi * (np.arange(self.sosNumSins, dtype=np.float64).reshape(1,-1,1,1,1)+1) + thetaN)/self.sosNumSins    # Shape: 1 x sosNumSins x nr x nt x numPath
        
        # Calculate the angles used in (6b) and (6c)
        angles = 2 * np.pi * self.dopplerShift * sosSampleTimes * np.cos(alphaN) + phiN                                     # Shape: sosNumSamples x sosNumSins x nr x nt x numPaths

        # Calculating final results based on (6a), (6b), and (6c)
        return np.sqrt(1/self.sosNumSins)*(np.cos(angles) + 1j*np.sin(angles)).sum(1)                                       # Shape: sosNumSamples x nr x nt x numPaths
    ...
    def sosGMEDS1(self, sosSampleTimes):            # Not documented
        ...
        # Using the common shape: numTimeSamples x numSin x nr x nt x numPath
        alphaIN = np.pi * (np.arange(self.sosNumSins, dtype=np.float64).reshape(1,-1,1,1,1)+.5)/(2*self.sosNumSins)                 # Shape: 1 x sosNumSins x 1 x 1 x 1
        alphaI0 = np.pi * (np.arange(self.numPaths, dtype=np.float64).reshape(1,1,1,1,-1)+1)/(4*self.sosNumSins*(self.numPaths+2))  # Shape: 1 x 1 x 1 x 1 x numPaths
        # Discrete Doppler frequencies:
        f1N, f2N = 2 * np.pi * self.dopplerShift * np.cos([alphaIN+alphaI0, alphaIN-alphaI0])                                       # Shape: 1 x sosNumSins x 1 x 1 x numPaths

        # See equation (2) in the above paper
        return np.sqrt(2/self.sosNumSins)*(   np.cos(2*np.pi*f1N*sosSampleTimes + self.sosTheta1N) +
                                           1j*np.cos(2*np.pi*f2N*sosSampleTimes + self.sosTheta2N)).sum(1)                          # Shape: sosNumSamples x nr x nt x numPaths

    # ************************************************************************************************************************************************
    def getChannelGains(self, channelTimes):        # Not documented (See the documentation of "getPathGains" in the base class)
        nr, nt = self.nrNt
        numChannels = len(channelTimes)
        sosSampleTimes = channelTimes[:,None,None,None,None]
        
        if self.sosType == 'GMEDS1':    channelGains = self.sosGMEDS1(sosSampleTimes)           # A deterministic SOS simulation
        elif self.sosType == 'Xiao':    channelGains = self.sosXiao(sosSampleTimes)             # A statistical SOS simulation
        else:                           assert False, "Unsupported SOS type '%s'!"%(self.sosType)
        # channelGains now has a shape of:  numChannels x nr x nt x numPaths

        # Apply the correlation matrix:
        # If 'self.correlationMatrix' is a scaler value, it means it is an identity matrix of the specified size. In this case there is no need
        # to apply the correlation matrix.
        if not np.isscalar(self.correlationMatrix):     # 'correlationMatrix' is an nt.nr by nt.nr square matrix
            corMat = (self.correlationMatrix * nt * nr / np.trace(self.correlationMatrix)) if self.normalizeGains else self.correlationMatrix
            sqrtCorrelationMatrix = sqrtm(corMat)
        
            # The following has the same effect of doing dot products of (1 x nr.nt) matrixes by (nr.nt x nr.nt) matrixes for all times and all paths which
            # results in (1 x nr.nt) matrixes.
            channelGains = (channelGains.reshape(numChannels,nr*nt,1,-1)*sqrtCorrelationMatrix.reshape(1,nr*nt,nr*nt,1)).sum(1).reshape(numChannels,nr,nt,-1)

        # Apply the LOS path gains
        if self.hasLos:
            # Update the first path information with the LOS gains
            k1st = 10**(self.kFactorLos/10.0)
            channelGains[:,:,:,0] = (channelGains[:,:,:,0] + np.sqrt(k1st) * np.exp( 2j * np.pi * self.losDopplerShift * channelTimes[:,None,None])) / np.sqrt(k1st+1)

        # Apply path powers:
        pN = 10.0**(self.pathPowers/10.0)                                       # Shape: n     (linear power values)
        channelGains *= np.sqrt(pN).reshape(1,1,1,-1)                           # Shape: numChannels x nr x nt x numPaths

        return channelGains                                                     # Shape: numChannels x nr x nt x numPaths
    ...
    def getSpatialCorrelationMatrix(self):          # Not documented
        ...
        try:                alpha, beta, gamma = alphBetaGamma[ self.txDir ][ self.polarization ][ self.mimoCorrelation ]
        except KeyError:    assert False, "The combination '%s, %s, %s' is not supported!"%(self.txDir, self.polarization, self.mimoCorrelation)
        
        # Calculating Correlation matrixes at gNB and UE sides
        ...
        # Note: A scaler value means an identity matrix of the specified size
        def powerMatrix(n): # This is used for a generalization of the matrixes in the tables mentioned below
        ...
        if self.polarization=='CrossPolar':
            ...
            if self.txDir == 'Downlink':    rSpat = pp.dot(np.kron( np.kron(gnbCorrelationMatrix, gg), ueCorrelationMatrix)).dot(pp.T)
            else:                           rSpat = pp.dot(np.kron( np.kron(ueCorrelationMatrix, gg), gnbCorrelationMatrix)).dot(pp.T)
        elif np.isscalar(ueCorrelationMatrix) and np.isscalar(gnbCorrelationMatrix):
            rSpat = ueCorrelationMatrix * gnbCorrelationMatrix  # Identity matrix of size: ueCorrelationMatrix * gnbCorrelationMatrix
        else:
            if np.isscalar(ueCorrelationMatrix):    ueCorrelationMatrix = np.eye(ueCorrelationMatrix)
            if np.isscalar(gnbCorrelationMatrix):   gnbCorrelationMatrix = np.eye(gnbCorrelationMatrix)
    ...
    def getPermutationMatrix(self):                 # Not documented
        # Getting permutation matrix P:
        # See TS 38.101-4 V17.4.0 (2022-03), Section B.2.3.2.1
        
        # P is an Nt*Nr by Nt*Nr matrix
        assert self.polarization=='CrossPolar', "Permutation Matrix is only used for the \"CrossPolar\" polarization mode!"
        nr, nt = self.nrNt
    ...
    def getPolarizationAngles(self):                # Not documented
        ...
        assert self.polarization=='CrossPolar', "Polarization Correlation Matrix is only used for the \"CrossPolar\" polarization mode!"
